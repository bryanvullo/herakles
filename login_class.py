...
class start:
	...
	def loginScreen(self, root):
		...
		requirements_label = Label(main, fg='red', text='Username must be atleast 4 characters \n Password must be atleast 6 characters long and have\n a capital letter, a special character, a number')
		requirements_label.config(font=('Courier', 20))
		requirements_label.grid(row=1, column=0, columnspan=3, padx=10, pady=10)

		u_name_label= Label(main, text='Username:')
		u_name_label.grid(row=2, column=0, pady=(10,0), padx=5)
		u_name = Entry(main, width=45)
		u_name.grid(row=2, column=1, padx=20, pady=(10,0))

		p_word_label= Label(main, text='Password:')
		p_word_label.grid(row=3, column=0, padx=5)
		...
		check.grid(row=3, column=2, padx=5)
		...
		confirm_button.grid(row=4, column=0, columnspan=3, padx=10, pady=10)

		newacc_button=Button(main, text='Create Free Account', command=self.createScreen)
		newacc_button.config(font=('Courier', 20))
		newacc_button.grid(row=5, column=0, columnspan=3, padx=10, pady=10)
	...
	def createScreen(self):
		...
		requirements_label = Label(top, fg='red', text='Username must be atleast 4 characters \n Password must be atleast 6 characters long and have \n a capital letter, a special character, a number')
		requirements_label.config(font=('Courier', 20))
		requirements_label.grid(row=1, column=0, columnspan=3, padx=10, pady=10)
		...
		confirm_label.grid(row=4, column=0, padx=5)
		...
		create_button.grid(row=5, column=0, columnspan=3, padx=10, pady=10)

		close_button=Button(top, text='Close', command=self.close)
		close_button.config(font=('Courier', 20))
		close_button.grid(row=6, column=0, columnspan=3, padx=10, pady=10)
